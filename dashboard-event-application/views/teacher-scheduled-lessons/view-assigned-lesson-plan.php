...
<div class="box">
    <div class="box__head"><h5><?php echo Label::getLabel('LBL_View_Lesson_Plan'); ?></h5></div>
    <?php if (!empty($data)) { //echo "<pre>";print_r($data); ?>
            ...
            <div class="content-repeated-container">
                <div class="content-repeated">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-sm-8">
                            <strong><?php echo $data['tlpn_title']; ?></strong>
                        </div>
                    </div>
                </div>
                <div class="content-repeated">
                ...
                <div class="content-repeated">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-sm-8">
                            <?php echo @$statusArr[$data['tlpn_level']]; ?>
                        </div>
                    </div>
                </div>
                <div class="content-repeated">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-sm-8">
                            <?php
                            if ($data['tlpn_id'] > 0) {
                                $file_rows = AttachedFile::getMultipleAttachments(AttachedFile::FILETYPE_LESSON_PLAN_FILE, $data['tlpn_id'], 0);
                                if ($file_rows) {
                ...
                <div class="content-repeated">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-sm-4">
                            <p class="-small-title"><strong><?php echo Label::getLabel('LBL_Links'); ?></strong></p>
                        </div>
                        <div class="col-xl-8 col-lg-8 col-sm-8">
                            <?php 
                                $url = strpos($data['tlpn_links'],"https"); 
                                $youtubeLink = substr($data['tlpn_links'],$url);
                            ?>
                            <a href='<?php echo $youtubeLink ?>'> <?php echo $data['tlpn_links']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
