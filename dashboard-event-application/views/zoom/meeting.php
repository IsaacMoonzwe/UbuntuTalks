...
<script src="<?php echo CONF_WEBROOT_FRONT_URL ?>js/zoom_tool.js"></script>
<script src="<?php echo CONF_WEBROOT_FRONT_URL ?>js/vconsole.min.js"></script>
<script src="<?php echo CONF_WEBROOT_FRONT_URL ?>js/meeting.js"></script>