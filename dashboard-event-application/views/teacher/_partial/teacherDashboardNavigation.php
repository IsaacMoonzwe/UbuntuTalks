...
<div class="menu-group">
    ...
    <nav class="menu menu--primary">
        <ul>
            ...
            <li class="menu__item profile-setting-js aside--progress--menu <?php
            echo ($isAcountSettingComplete) ? 'is-completed' : '';
            echo ($controllerName == "Account") ? ' is-active' : '';
            ?>">
            ...
            <li class="menu__item availability-setting-js aside--progress--menu <?php
            echo ($tpp['generalAvailabilityCount'] == applicationConstants::YES) ? ' is-completed' : '';
            echo ($controllerName == "Teacher" && $action == "availability") ? ' is-active' : '';
            ?>">
...
<div class="menu-group">
    ...
    <nav class="menu menu--primary">
        <ul>
            ...
            <li class="menu__item <?php echo ($controllerName == "TeacherKidsClasses") ? 'is-active' : ''; ?>">
                <a href="<?php echo CommonHelper::generateUrl('TeacherKidsClasses'); ?>">
                    <svg class="icon icon--group-classes margin-right-2"><use xlink:href="<?php echo CONF_WEBROOT_URL . 'images/sprite.yo-coach.svg#group-classes'; ?>"></use></svg>
                    <span>UT Kids</span>
                </a>
            </li>
...
<div class="menu-group">
    ...
    <nav class="menu menu--primary">
        <ul>
            <li class="d-none menu__item <?php echo ($controllerName == "Teacher" && $action == "orders") ? 'is-active' : ''; ?>">
