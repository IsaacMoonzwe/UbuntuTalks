                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-7">
                        <div class="blog__content">
                            ...
                            <h2><a href="<?php echo CommonHelper::generateUrl('Blog', 'postDetail', array($blogPost['post_id'])); ?>" title="<?php echo $blogPost['post_title']; ?>">
                                    <?php echo $blogPost['post_title']; ?></a></h2>
                            <div class="blog__actions">
                                <span class="blog__action -display-inline">
                                    ...
                                    <?php echo Label::getLabel('Lbl_on'); ?> <span class="text--dark"><?php echo FatDate::format($blogPost['post_published_on']); ?> </span>
                            </div>
                            <span class="-gap"></span>
                            <a class="btn btn--primary btn--wide btn--large" href="<?php echo CommonHelper::generateUrl('Blog', 'postDetail', array($blogPost['post_id'])); ?>"><?php echo Label::getLabel('Lbl_View_Full_Post'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
