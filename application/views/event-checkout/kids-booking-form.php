...
<div class="box box--checkout">
    <div class="box__head">
        <h4><?php echo Label::getLabel('LBL_KIDS_BOOKING_FORM'); ?></h4>
        <div class="step-nav">
            <ul>
                            ...
                            <div class="field-set">
                                <div class="caption-wraper">
                                    <label class="field_label">
                                        <?php 
                                            $child_title = "Number of children";
                                ...
                                <div class="field-wraper">
                                    <div class="field_cover">
                                        <?php $dropdown_child_title = "Select number of children"; //echo $contactFrm->getFieldHTML('child'); ?>
    ...
    <div class="box-foot">
        ...
        <a href="javascript:void(0);" class="btn btn--primary color-white" onclick="cart.proceedToStep({fromKids:1,teacherId: <?php echo $teacher['user_id']; ?>}, 'getPaymentSummary');"><?php echo Label::getLabel('LBL_NEXT'); ?></a>
    </div>
</div>
<script>
