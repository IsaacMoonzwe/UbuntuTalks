...
<?php if ($teachers) { ?>
    <div class="group-contact-form-section">
        <p>To request a personalized group class<br>
            <a href="javascript:void(0);" onclick="groupClassesForm();" class="groupcontact groupcontactformbutton">
                Click here and fill out a form.
            </a>
        </p>
    </div>

    <div class="sorting__head teachers">
