    ...
    <div class="container container--fixed">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-lg-10 col-xl-10">
                <div class="construction-message-wrapper">
                    <div class="construction-message">
                        <h1><?php echo Label::getLabel('MSG_We_will_be_back_soon'); ?></h1>
                        <svg class="svg-maintenance" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
                            <g>
                                <g transform="rotate(159.49 31 37)">
                                    <path class="-color-primary" d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
                                          ...
                                          c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#103c5d"></path>
                                ...
                                <g transform="rotate(-59.2344 78 21)">
                                    <path class="-color-secondary" d="M93.068,19.253L99,16.31c-0.371-1.651-0.934-3.257-1.679-4.776l-6.472,1.404c-0.902-1.436-2.051-2.735-3.42-3.819
                                          ...
                                          C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#103c5d"></path>
                                    <animateTransform attributeName="transform" begin="0s" dur="2s" type="rotate" from="0 78 21" to="-360 78 21" repeatCount="indefinite" <="" animatetransform=""> </animateTransform></g>  </g> 
                        </svg>
                        <br/><br/><br/><br/><br/>
                        <h6><?php echo Label::getLabel('MSG_Maintenance_Mode_Text'); ?></h6>
                    </div>
                </div>
            </div>
        </div>
