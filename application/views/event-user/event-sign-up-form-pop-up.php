...
<h2 class="-align-center"><?php echo Label::getLabel('LBL_Event_Registration'); ?></h2>
    ...
    $frm->setFormTagAttribute('onsubmit', 'EventSetUpSignUp(this); return(false);');
    ...
    // $fldSponsorship = $frm->getField('pjname');
    // $fldSponsorship->developerTags['col'] = 12;
    ...
    <div class="-align-center">
        <p><?php echo Label::getLabel('LBL_Already_have_an_account?'); ?> <a href="javascript:void(0);" onClick="EventLogInFormPopUp()" class="-link-underline link-color"><?php echo Label::getLabel('LBL_Sign_In'); ?></a></p>
    </div>
</div>
</div>
<script>
    eventCart.props.sponsershipPlan = parseInt('<?php echo $lessonDuration; ?>');
</script>
<script>
