...
<div class="box box--checkout">
    <div class="box__head">
        <a href="javascript:void(0);" onclick="GetSymposiumTickets('<?php echo $method; ?>',1,eventCart.props.symposiumTicket);" class="btn btn--bordered color-black btn--back">
    ...
    <div class="box__body">
        <div class="selection-tabs selection--checkout selection--duration selection--onehalf sponsorship-tabs">
            ...
            <div>
                <div>
                    <h2>Pre-Symposium Dinner Billing Information</h2><br>
                </div>
            </div>
    ...
    <div class="box-foot">
        ...
        <div class="box-foot__right">
            <a href="javascript:void(0);" class="btn btn--primary color-white" onclick="GetSymposiumTicketsPaymentSummary(eventCart.props.symposiumPlan,eventCart.props.symposiumTicket,eventCart.props.eventUserSelectedStaus);"><?php echo Label::getLabel('LBL_NEXT'); ?></a>
        </div>
    </div>
</div>
<script>
