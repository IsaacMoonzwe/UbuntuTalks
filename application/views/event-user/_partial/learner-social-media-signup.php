...
<div class="group group--social">
	...
	<a class="google-login" href="<?php echo CommonHelper::generateUrl('EventUser', 'socialMediaLogin', array('google', $userType)); ?>">
	...
	function getUserData(accessToken) {
		FB.api('/me?fields=id,name,email, first_name, last_name', function(response) {
			if (!response.id || typeof response == "undefined" || response.error) {
				...
				fcom.updateWithAjax(fcom.makeUrl('EventUser', 'loginFacebook'), response, function(t) {
					location.href = t.url;
				});
			}
