...
<div class="box box--checkout">
    <div class="box__head">
        <a href="javascript:void(0);" onclick="GetConcertTickets('<?php echo $method; ?>',1,eventCart.props.countOfTickets);" class="btn btn--bordered color-black btn--back">
    ...
    <div class="box-foot">
        ...
        <div class="box-foot__right">
            <a href="javascript:void(0);" class="btn btn--primary color-white" onclick="GetConcertTicketsPaymentSummary(eventCart.props.concertPlan,eventCart.props.concertTicket,eventCart.props.eventUserSelectedStaus);"><?php echo Label::getLabel('LBL_NEXT'); ?></a>
        </div>
    </div>
</div>
