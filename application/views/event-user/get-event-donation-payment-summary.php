...
<div class="box box--checkout">
    <div class="box__head">
        ...
        <a href="javascript:void(0);" onclick="RegisterDonationEventUser(eventCart.props.donationAmount);" class="btn btn--bordered color-black btn--back">
        ...
        <div class="step-nav">
            <ul>
                <li class="step-nav_item is-completed"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_1'); ?></a><span class="step-icon"></span></li>
                <li class="step-nav_item is-completed"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_2'); ?></a><span class="step-icon"></span></li>
                <li class="step-nav_item is-process"><a href="javascript:void(0);"><?php echo Label::getLabel('LBL_3'); ?></a><span class="step-icon"></span></li>
            </ul>
        </div>
        <!-- <?php } ?> -->
    </div>
                ...
                <div class="col-md-6  <?php echo ($cartData['orderNetAmount'] > 0) ? ' col-xl-5 offset-xl-1' : 'col-xl-12'; ?>">
                    ...
                    <!--  <div class="apply-coupon">
                        ...
                        <input type="text" id="coupon_code" name="coupon_code" placeholder="<?php echo Label::getLabel('LBL_ENTER_COUPON_CODE'); ?>">
                            <a href="javascript:void(0);" onclick="eventApplyPromoCode(document.getElementById('coupon_code').value,'donation');" class="btn btn--secondary btn--small color-white"><?php echo Label::getLabel('LBL_APPLY'); ?></a>
                    </div>  -->
                    <!-- <div class="apply-coupon">
                    ...
                    <?php if (!empty($cartData['cartDiscounts']['coupon_code'])) { ?>
                        <div class="coupon-applied">
                            ...
                            <a href="javascript:void(0);" onclick="eventRemovePromoCode('donation');" class="btn btn--coupon btn--small"><?php echo Label::getLabel('LBL_REMOVE'); ?></a>
                        </div>
                    <?php } ?>
                    <div class="selection-title">
                    ...
                    <p class="payment-note color-secondary">
                        <?php echo Label::getLabel('LBL_Donation_Payment_Summary');
