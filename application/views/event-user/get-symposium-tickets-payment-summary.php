...
<div class="box box--checkout">
    <div class="box__head">
        ...
        <a href="javascript:void(0);" onclick="RegisterSymposiumUser(eventCart.props.symposiumPlan,eventCart.props.symposiumTicket);" class="btn btn--bordered color-black btn--back">
                ...
                <div class="row">
                    ...
                    <?php if ($cartData['orderNetAmount'] > 0) {  ?>
                                    ...
                                    <label class="selection-tabs__label payment-method-js">
                                        ...
                                        <div class="selection-tabs__title">
                                            ...
                                            <?php } else if ($value['pmethod_name'] == "Google Pay") { ?>
                                                ...
                                                64px" src="../../../public/images/GPay_Acceptance_Mark_800.png" alt="GooglePay" />
                                            <?php } else {
                        ...
                        <div class="col-md-6  <?php echo ($cartData['orderNetAmount'] > 0) ? ' col-xl-5 offset-xl-1' : 'col-xl-12'; ?>">
                            ...
                            <div class="apply-coupon">
                                ...
                                <a href="javascript:void(0);" onclick="eventApplyPromoCode(document.getElementById('coupon_code').value,'SymposiumDinnerPlan');" class="btn btn--secondary btn--small color-white"><?php echo Label::getLabel('LBL_APPLY'); ?></a>
                            </div>
                    <!-- <div class="apply-coupon">
                    ...
                    <?php if (!empty($cartData['cartDiscounts']['coupon_code'])) { ?>
                        <div class="coupon-applied">
                            ...
                            <a href="javascript:void(0);" onclick="eventRemovePromoCode('SymposiumDinnerPlan');" class="btn btn--coupon btn--small"><?php echo Label::getLabel('LBL_REMOVE'); ?></a>
                        </div>
                    <?php } ?>
                    <div class="selection-title">
