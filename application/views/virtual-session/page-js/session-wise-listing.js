...
(function () {
	...
	getSessionWiseListing= function () {
		$(sessionwiselisting).html(fcom.getLoader());
		fcom.ajax(fcom.makeUrl('VirtualSession', 'sessionWiseListing'), '', function (t) {
			$(sessionwiselisting).html(t);
		});
	};
