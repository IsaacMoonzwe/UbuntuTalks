...
<script type="text/javascript">
  ...
  async function initialize() {
    const {
      clientSecret
    } = await fetch("<?php echo  CommonHelper::generateFullUrl('GooglePayPay', 'create'); ?>", {
      method: "POST",
      headers: {
  ...
  async function handleSubmit(e) {
    ...
    const {
      ...
      confirmParams: {
        ...
        return_url: "<?php echo  CommonHelper::generateFullUrl('GooglePayPay', 'payment') . '?orderId=' . $orderId . '&session_id=' . $session_id; ?>",
      },
    });
