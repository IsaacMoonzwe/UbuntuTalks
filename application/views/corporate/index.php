...
$contactFrm->setFormTagAttribute('action', CommonHelper::generateUrl('Business', 'contactSubmit'));
        ...
        <div class="section contact-form">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 banner-images">
                        <div class="banner__media ">
                            <img src="<?php echo CommonHelper::generateUrl('Image', 'BusinessCampaign', [$siteLangId]); ?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center referral-campaign-form">
                    <div class="col-lg-6">
                        <div class="banner__media_content">
                            <?php echo FatUtility::decodeHtmlEntities($BusinessCampaignLeftSectionBanner); ?>
                        </div>
                    </div>
                    <div class="col-lg-1">
                    </div>
                ...
                <?php echo FatUtility::decodeHtmlEntities($BusinessCampaignBenifitsBanner); ?>
            </div>
        </div>
    </div>
</section>
