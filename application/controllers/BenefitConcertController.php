...
class BenefitConcertController extends AdminBaseController
{
    ...
    public function search()
    {
        ...
        $srch->addMultipleFields(['t.*', 't_l.benefit_concert_plan_title', 't_l.benefit_concert_text']);
    ...
    public function form($testimonialId)
    {
        ...
        if (0 < $testimonialId) {
            $data = BenefitConcert::getAttributesById($testimonialId, [
                'benefit_concert_id',
                'benefit_concert_identifier',
                'benefit_concert_plan_title',
                'benefit_concert_plan_price',
                'benefit_concert_plan_description',
                'benefit_concert_starting_days',
                'benefit_concert_starting_date',
                'benefit_concert_ending_date',
                'benefit_concert_plan_note',
                'benefit_concert_plan_combo_events'
            ]);
            if ($data === false) {
    ...
    public function langSetup()
    {
        ...
        $data = [
            ...
            'benefit_concert_plan_title' => $post['benefit_concert_plan_title'],
    ...
    private function getLangForm($testimonialId = 0, $lang_id = 0)
    {
        ...
        $frm->addRequiredField(Label::getLabel('LBL_Testimonial_Title', $this->adminLangId), 'benefit_concert_plan_title');
