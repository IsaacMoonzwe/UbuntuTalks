...
class FaithgroupsController extends MyAppController
{
    ...
    public function index()
    {
        ...
        $FaithGroupsCampaignLeftSectionBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_FAITH_GROUPS_CAMPAIGN_LEFT_SECTION_BANNER, $this->siteLangId);
        $FaithGroupsCampaignBenifitsBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_FAITH_GROUPS_CAMPAIGN_BENEFITS_SECTION_BANNER, 
        $this->siteLangId);
        $this->set('FaithGroupsCampaignBenifitsBanner', $FaithGroupsCampaignBenifitsBanner);
        $this->set('ReferralCampaignBanner', $ReferralCampaignBanner);
        $this->set('FaithGroupsCampaignLeftSectionBanner', $FaithGroupsCampaignLeftSectionBanner);
    ...
    public function contactSubmit()
    {
        ...
        if (false === $post) {
            ...
            FatApp::redirectUser(CommonHelper::generateUrl('faith-groups'));
        }
        ...
        foreach ($email as $emailId) {
            ...
            if (!$email->sendFaithGroupsFormEmail($emailId, $this->siteLangId, $post)) {
