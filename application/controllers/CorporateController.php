...
class CorporateController extends MyAppController
{
    ...
    public function index()
    {
        ...
        $BusinessCampaignLeftSectionBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_BUSINESS_CAMPAIGN_LEFT_SECTION_BANNER, $this->siteLangId);
        $BusinessCampaignBenifitsBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_BUSINESS_CAMPAIGN_BENEFITS_SECTION_BANNER, 
        $this->siteLangId);
        $this->set('BusinessCampaignBenifitsBanner', $BusinessCampaignBenifitsBanner);
        $this->set('ReferralCampaignBanner', $ReferralCampaignBanner);
        $this->set('BusinessCampaignLeftSectionBanner', $BusinessCampaignLeftSectionBanner);
    ...
    public function contactSubmit()
    {
        ...
        if (false === $post) {
            ...
            FatApp::redirectUser(CommonHelper::generateUrl('business'));
        }
        ...
        foreach ($email as $emailId) {
            ...
            if (!$email->sendBusinessFormEmail($emailId, $this->siteLangId, $post)) {
