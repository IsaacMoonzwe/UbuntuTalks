...
class LearnerFaqController extends MyAppController
{

    public function index()
    {
        $srch = LearnerFaq::getSearchObject($this->siteLangId);
        ...
        $this->set('typeArr', LearnerFaq::getFaqCategoryArr($this->siteLangId));
