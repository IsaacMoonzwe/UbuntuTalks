...
class InstructorFaqController extends AdminBaseController
{
    ...
    {   
        ...
        $this->_template->render(true, true, 'instructor-faq/index.php');
    }

    public function search()
    {
       
        $srch = InstructorFaq::getSearchObject($this->adminLangId, false);
        ...
        $this->_template->render(false, false, 'instructor-faq/search.php');
    }
    ...
    public function form($faqId)
    {
        ...
        if (0 < $faqId) {
            $data = InstructorFaq::getAttributesById($faqId, ['faq_id', 'faq_identifier', 'faq_category', 'faq_active']);
            if ($data === false) {
        ...
        $this->set('frm', $frm);
        //$this->_template->render(false, false);
        $this->_template->render(false, false, 'instructor-faq/form.php');
    }
    ...
    public function setup()
    {
        ...
        $record = new InstructorFaq($faqId);
        ...
        if ($faqId > 0) {
            ...
            foreach ($languages as $langId => $langName) {
                if (!$row = InstructorFaq::getAttributesByLangId($langId, $faqId)) {
                    $newTabLangId = $langId;
                    break;
                }
            }
    ...
    public function langForm($faqId = 0, $lang_id = 0)
    {
        ...
        $langData = InstructorFaq::getAttributesByLangId($lang_id, $faqId);
        ...
        $this->_template->render(false, false, 'instructor-faq/lang-form.php');
    }
    ...
    public function changeStatus()
    {
        ...
        $data = InstructorFaq::getAttributesById($faqId, ['faq_id', 'faq_active']);
        if ($data == false) {
    ...
    public function deleteRecord()
    {
        ...
        $LessonPackageObj = new InstructorFaq($faq_id);
