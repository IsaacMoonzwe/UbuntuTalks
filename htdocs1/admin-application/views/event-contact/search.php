...
$arr_flds = array(
    ...
    'event_contact_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'event_contact_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'event_contact_identifier':
                if ($row['event_contact_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['event_contact_label'], true);
                ...
                break;
            case 'event_contact_active':
                $active = "";
                $statusAct = '';
                if ($row['event_contact_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['event_contact_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
