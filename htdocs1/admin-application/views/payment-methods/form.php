...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Payment_Method_Setup', $adminLangId); ?></h4>
    </div>
    <div class="sectionbody space">      
        <div class="tabs_nav_container responsive flat">
            <ul class="tabs_nav">
                <li><a class="active" href="javascript:void(0)" onclick="gatewayForm(<?php echo $pmethod_id ?>);"><?php echo Label::getLabel('LBL_General', $adminLangId); ?></a></li>
                <?php
