                    ...
                    <ul class="tabs_nav">
                        ...
                        if ($slide_id > 0) {
                            foreach ($languages as $langId => $langName) {
                                ?>
                                <li><a class="<?php echo ($slide_lang_id == $langId) ? 'active' : '' ?>" href="javascript:void(0);" onclick="slideLangForm(<?php echo $slide_id ?>, <?php echo $langId; ?>);"><?php echo $langName; ?></a></li>
                                <?php
                            }
                        }
                        ?>
                        <li><a href="javascript:void(0)" <?php if ($slide_id > 0) { ?> onclick="slideMediaForm(<?php echo $slide_id ?>);" <?php } ?>><?php echo Label::getLabel('LBL_Media', $adminLangId); ?></a></li>
                    </ul>
