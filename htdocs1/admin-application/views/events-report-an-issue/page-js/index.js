...
(function () {
    ...
    searchOrderPuchasedLessons = function (form, page) {
        ...
        fcom.ajax(fcom.makeUrl('EventsReportAnIssue', 'search'), data, function (res) {
    ...
    updateOrderStatus = function (obj, id, value, oldValue) {
        ...
        fcom.ajax(fcom.makeUrl('EventsReportAnIssue', 'updateOrderStatus'), {"order_id": id, "order_is_paid": value}, function (json) {
            res = $.parseJSON(json);
            if (res.status == "1") {
