...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Comment_Details', $adminLangId); ?></h4>
    </div>
    <div class="sectionbody space">
        <div class="border-box border-box--space"><div class="repeatedrow">
                <div class="rowbody">
                    <div class="listview">
                        <dl class="list">
                            <dt><?php echo Label::getLabel('LBL_Full_Name', $adminLangId); ?></dt>
                            <dd><?php echo CommonHelper::displayName($data['bpcomment_author_name']); ?></dd>
                        </dl>
                        <dl class="list">
                            <dt><?php echo Label::getLabel('LBL_Email', $adminLangId); ?></dt>
                        ...
                        <dl class="list">
                            <dt><?php echo Label::getLabel('LBL_Comment', $adminLangId); ?></dt>
                            <dd><?php echo nl2br($data['bpcomment_content']); ?></dd>
                        </dl>
                        <dl class="list">
                            <dt><?php echo Label::getLabel('LBL_User_IP', $adminLangId); ?></dt>
                            <dd><?php echo $data['bpcomment_user_ip']; ?></dd>
                        </dl>
                        <dl class="list">
                            <dt><?php echo Label::getLabel('LBL_User_Agent', $adminLangId); ?></dt>
            ...
            <div class="repeatedrow">
                <div class="form_horizontal">
                    <h3><i class="ion-person icon"></i><?php echo Label::getLabel('LBL_Update_Status', $adminLangId); ?></h3>
                </div>
                <div class="rowbody">
                    <div class="listview">
                        <?php
