...
$userNameFld->addFieldTagAttribute('placeholder', Label::getlabel('LBL_Username', $adminLangId));
$passwordFld = $frm->getField('password');
$passwordFld->addFieldTagAttribute('placeholder', Label::getlabel('LBL_Password', $adminLangId));
                    ...
                    <div class="col-md-6">
                        <div class="field-set">
                            <label class="statustab -txt-uppercase">
                                ...
                                <?php echo Label::getlabel('LBL_Remember_me', $adminLangId); ?>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="field-set">
                            <a href="<?php echo CommonHelper::generateUrl('adminGuest', 'forgotPasswordForm'); ?>" class="-link-underline -txt-uppercase -float-right"><?php echo Label::getLabel('LBL_Forgot_Password?', $adminLangId); ?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
