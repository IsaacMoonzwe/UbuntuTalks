...
(function() {
	...
	updatePayment = function (frm){
		...
		fcom.updateWithAjax(fcom.makeUrl('ReportAnIssue', 'updatePayment'), data, function(t) {
	...
	updateAssignClassStatus = function(obj, id, value, oldValue){
		...
		fcom.ajax(fcom.makeUrl('ReportAnIssue','updateAssignClass'),{"sldetail_id":id, "slesson_status" : value},function(json){
			res = $.parseJSON(json);
			if(res.status == "1"){
