    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'action':
                ...
                $innerLi->appendElement("a", array('href' => CommonHelper::generateUrl('ReportAnIssue', 'view', array($row['order_id'])), 'class' => 'button small green', 'title' => Label::getLabel('LBL_View_Details', $adminLangId)), Label::getLabel('LBL_View_Details', $adminLangId), true);
                if ($row['order_is_paid'] == Order::ORDER_IS_PAID) {
                    $innerLi = $innerUl->appendElement('li');
                    $innerLi->appendElement("a", array('href' => CommonHelper::generateUrl('ReportAnIssue', 'viewSchedules', array("all", $row['order_id'])), 'class' => 'button small green', 'title' => Label::getLabel('LBL_View_Schedules', $adminLangId)), Label::getLabel('LBL_View_Schedules', $adminLangId), true);
                }
                break;
            default:
