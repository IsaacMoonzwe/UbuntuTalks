        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 space">
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Label::getLabel('LBL_Manage_Language', $adminLangId); ?></h5>
                ...
                <section class="section">
                    <div class="sectionhead">
                        <h4><?php echo Label::getLabel('LBL_Languages_Listing', $adminLangId); ?> </h4>
                        <?php
                        if ($canEdit) {
                            ...
                            $innerLiAddCat->appendElement('a', array('href' => 'javascript:void(0)', 'class' => 'button small green', 'title' => Label::getLabel('LBL_Add_Blog_Post', $adminLangId), "onclick" => "languageForm(0)"), Label::getLabel('LBL_Add_Language', $adminLangId), true);
                            echo $ul->getHtml();
                        }
                        ?>
                    </div>
