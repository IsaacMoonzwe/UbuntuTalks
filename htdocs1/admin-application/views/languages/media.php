...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Language_Setup', $adminLangId); ?></h4>
    </div>
        ...
        <div class="row">		
            <div class="col-sm-12">
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        <li><a href="javascript:void(0)" onclick="editLanguageForm(<?php echo $language_id ?>);"><?php echo Label::getLabel('LBL_General', $adminLangId); ?></a></li>
                        <?php $inactive = ($language_id == 0) ? 'fat-inactive' : ''; ?>
                        <li  class="<?php echo $inactive; ?>"><a class="active" href="javascript:void(0)" <?php if ($language_id > 0) { ?> onclick="mediaForm(<?php echo $language_id ?>);" <?php } ?> ><?php echo Label::getLabel('LBL_Media', $adminLangId); ?></a></li>
                    </ul>
