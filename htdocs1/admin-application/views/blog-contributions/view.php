...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Contribution_Detail', $adminLangId); ?></h4>
    </div>
            ...
            <div class="repeatedrow">
                <div class="rowbody">
                    <div class="listview">
                        ...
                        <dl class="list">
                            <dt><?php echo Label::getLabel('LBL_Phone', $adminLangId); ?></dt>
                        ...
                        <?php if (!empty($attachedFile)) { ?>
                            <dl class="list">
                                <dt><?php echo Label::getLabel('LBL_Attached_File', $adminLangId); ?></dt>
