...
$arr_flds = array(
    ...
    'language_symposium_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'language_symposium_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'language_symposium_identifier':
                if ($row['language_symposium_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['language_symposium_label'], true);
                ...
                break;
            case 'language_symposium_active':
                $active = "";
                $statusAct = '';
                if ($row['language_symposium_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['language_symposium_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
