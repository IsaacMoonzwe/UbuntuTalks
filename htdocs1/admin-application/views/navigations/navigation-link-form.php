...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Navigation_Link_Setup', $adminLangId); ?></h4>
    </div>
        ...
        <div class="row">	
            <div class="col-sm-12">
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        <li><a class="active" href="javascript:void(0)" onclick="navigationLinkForm(<?php echo $nav_id . ',' . $nlink_id ?>);"><?php echo Label::getLabel('LBL_General', $adminLangId); ?></a></li>
                        <?php
