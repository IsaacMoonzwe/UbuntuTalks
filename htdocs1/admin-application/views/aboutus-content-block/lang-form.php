...
$edFld = $blockLangFrm->getField('aboutus_content_block_content');
...
<div id="editor_default_content" style="display:none;">
    <?php echo (isset($epageData)) ? html_entity_decode($epageData['aboutus_content_block_default_content']) : ''; ?>
</div>
<!-- ] -->
        ...
        <div class="row">	
            <div class="col-sm-12">
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        <li><a  href="javascript:void(0)" onclick="addBlockForm(<?php echo $epage_id ?>);"><?php echo Label::getLabel('LBL_General', $adminLangId); ?></a></li>
                        <?php foreach ($languages as $langId => $langName) { ?>
                            <li >
                                <a class="<?php echo ( $epage_lang_id == $langId) ? 'active' : '' ?>" href="javascript:void(0);"  onclick="addBlockLangForm(<?php echo $epage_id ?>, <?php echo $langId; ?>);" >
                                    <?php echo Label::getLabel('LBL_' . $langName, $adminLangId); ?>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
