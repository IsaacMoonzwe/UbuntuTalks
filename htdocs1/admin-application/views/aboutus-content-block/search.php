...
$arr_flds = array(
    ...
    'aboutus_content_block_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'aboutus_content_block_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'aboutus_content_block_identifier':
                if ($row['aboutus_content_block_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['aboutus_content_block_label'], true);
                ...
                break;
            case 'aboutus_content_block_active':
                $active = "";
                $statusAct = '';
                if ($row['aboutus_content_block_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['aboutus_content_block_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
