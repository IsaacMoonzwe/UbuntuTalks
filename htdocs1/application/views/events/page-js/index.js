...
(function () {
	...
	// 	$(donation).html(fcom.getLoader());
	// 	fcom.ajax(fcom.makeUrl('Events', 'donation'), '', function (t) {
	// 		$(donation).html(t);
	// 	});
	// };

	// getAgenda = function () {
	// 	$(agenda).html(fcom.getLoader());
	// 	fcom.ajax(fcom.makeUrl('Events', 'agenda'), '', function (t) {
	// 		$(agenda).html(t);
	// 	});
	// };

	// getTravelAccommodation = function () {
	// 	$(accommodation).html(fcom.getLoader());
	// 	fcom.ajax(fcom.makeUrl('Events', 'travelAccommodation'), '', function (t) {
	// 		$(accommodation).html(t);
	// 	});
	// };

	// getSafety = function () {
	// 	$(safety).html(fcom.getLoader());
	// 	fcom.ajax(fcom.makeUrl('Events', 'covid'), '', function (t) {
	// 		$(safety).html(t);
	// 	});
	// };

	// getContact = function () {
	// 	$(contact).html(fcom.getLoader());
	// 	fcom.ajax(fcom.makeUrl('Events', 'contact'), '', function (t) {
	// 		$(contact).html(t);
	// 	});
	// };

	// getPress = function () {
	// 	$(press).html(fcom.getLoader());
	// 	fcom.ajax(fcom.makeUrl('Events', 'press'), '', function (t) {
	// 		$(press).html(t);
	// 	});
	// };
	...
	loadFinancialSummary = function () {
		...
		fcom.ajax(fcom.makeUrl('EventCheckout', 'listFinancialSummary'), '', function (ans) {
	...
	loadPaymentSummary = function () {
		...
		fcom.ajax(fcom.makeUrl('EventCheckout', 'paymentSummary'), '', function (ans) {
			try {
				data = JSON.parse(ans);
				if (data.redirectUrl != '') {
	...
	walletSelection = function (el) {
		...
		fcom.ajax(fcom.makeUrl('EventCheckout', 'walletSelection'), data, function (ans) {
			loadPaymentSummary();
			loadFinancialSummary();
			$.loader.hide();
		});
	...
	confirmOrder = function (frm) {
		...
		$.loader.show();
		fcom.ajax(fcom.makeUrl('EventCheckout', 'confirmOrder'), data, function (ans) {
			try {
	...
	applyPromoCode = function (frm) {
		...
		fcom.updateWithAjax(fcom.makeUrl('EventCart', 'applyPromoCode'), data, function (res) {
	...
	removePromoCode = function () {
		fcom.updateWithAjax(fcom.makeUrl('EventCart', 'removePromoCode'), '', function (res) {
			loadFinancialSummary();
			loadPaymentSummary();
		});
	};
	...
	addToCart = function(teacherId, languageId, lessonDuration, lessonQty) {
        ...
        fcom.ajax(fcom.makeUrl('EventCart', 'add'), data, function (ans) {
	...
	getTeacherPriceSlabs = function (languageId, lessonDuration) {
		...
		$.loader.show()
		fcom.ajax(fcom.makeUrl('EventCheckout', 'getTeacherPriceSlabs'), data, function (ans) {
	...
	getBookingDurations = function () {
		fcom.ajax(fcom.makeUrl('EventCheckout', 'getBookingDurations'), '', function (ans) {
