...
<?php if (count($rows) > 0) { ?>
        ...
        <div class="form__body padding-0">
            <div class="table-scroll">
                <table class="table table--bordered table--responsive">
                    <tbody>
                        <tr class="title-row">
                            <th><?php echo Label::getLabel('LBL_Resume', $siteLangId); ?></th>
                            <th><?php echo Label::getLabel('LBL_StartEend', $siteLangId); ?></th>
                            <th><?php echo Label::getLabel('LBL_Certificate', $siteLangId); ?></th>
                            <th><?php echo Label::getLabel('LBL_Actions', $siteLangId); ?></th>
                        </tr>
                        <?php foreach ($rows as $row) { ?>
                            <tr>
                                <td>
                                    <div class="flex-cell">
                                        <div class="flex-cell__label"><?php echo Label::getLabel('LBL_Resume Information', $siteLangId); ?></div>
                                ...
                                <td>
                                    <div class="flex-cell">
                                        <div class="flex-cell__label"><?php echo Label::getLabel('LBL_Start-End', $siteLangId) ?> </div>
                                ...
                                <td>
                                    <div class="flex-cell">
                                        ...
                                        <div class="flex-cell__content">
                                            <?php
                                            $file_row = AttachedFile::getAttachment(AttachedFile::FILETYPE_USER_QUALIFICATION_FILE, $user['user_id'], $row['uqualification_id']);
                                            if (!empty($file_row)) {
                                            ?>
                                ...
                                <td>
                                    <div class="flex-cell">
                                        <div class="flex-cell__label"><?php echo Label::getLabel('LBL_ACTION') . ':'; ?></div>
                                        <div class="flex-cell__content">
                                            <div class="actions-group">
                                                <a href="javascript:void(0);" onClick="teacherQualificationForm(<?php echo $row['uqualification_id']; ?>)" class="btn btn--bordered btn--shadow btn--equal margin-1 is-hover">
                                                    ...
                                                    <div class="tooltip tooltip--top bg-black"><?php echo Label::getLabel('LBL_Edit', $siteLangId); ?></div>
                                                </a>
    ...
    <script>
        $('.qualification-add-js').removeClass('d-none');
    </script>
<?php } else { ?>
    <div class="message-display message--resume">
        ...
        <p><?php echo Label::getLabel('LBL_resume_upload_msg', $siteLangId); ?></p>
