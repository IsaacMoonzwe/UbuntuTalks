...
<div class="box box--checkout">
        ...
        <div class="selection-tabs selection--checkout selection--duration selection--onehalf">
            ...
            ?>
                <label class="selection-tabs__label">
                    <input type="radio" onchange="onPlanChange(this);" class="selection-tabs__input" value="<?php echo $duration['benefit_concert_plan_title']; ?>" <?php echo ($planSelected == $duration['benefit_concert_plan_title']) ? 'checked' : ''; ?> name="lessonDuration">
                    <div class="selection-tabs__title">
                        ...
                        <div>
                            <span>
                                <?php echo sprintf($newStrting[0] . "- ($" . $duration['benefit_concert_plan_price'] . ")"); ?>
                            </span>
                        </div>
                    </div>
                </label>
    ...
    <div class="box-foot">
        ...
        <div class="box-foot__right">
            ...
            <a href="javascript:void(0);" class="btn btn--primary color-white" onclick="GetConcertTickets(eventCart.props.concertPlan);"><?php echo Label::getLabel('LBL_NEXT'); ?></a>
        </div>
    </div>
</div>
<script>
