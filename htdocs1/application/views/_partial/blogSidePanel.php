                ...
                <div class="form__element">
                    <input class="form__input" placeholder="<?php echo Label::getLabel('LBL_Blog_Searchs'); ?>" name="keyword" type="text">
                        <input class="form__input" placeholder="<?php echo Label::getLabel('LBL_Blog_Searchs'); ?>" name="page" value="post-detail" type="hidden">
                            ...
                            <!--blog cta start here-->
                            <div class="box box--cta box--cta-blog -padding-30 -border -align-center">
                                ...
                                <a href="<?php echo CommonHelper::generateUrl('Blog', 'contributionForm'); ?>" class="btn btn--secondary btn--block btn--large"><span class="svg-icon"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                                            <g>
                                                <g>
                                                    <path fill="#fff" d="M255,0C114.75,0,0,114.75,0,255s114.75,255,255,255s255-114.75,255-255S395.25,0,255,0z M382.5,280.5h-102v102h-51v-102
                                            ...
                                            <?php if (!empty($categoriesArr)) { ?>
                                                <ul>
                                                    <?php foreach ($categoriesArr as $cat) { ?>
                                                        <li class="">
                                                            <a href="<?php echo CommonHelper::generateUrl('Blog', 'category', array($cat['bpcategory_id'])); ?>"><?php
                                                            ...
                                                            <?php if (count($cat['children'])) { ?>
                                                                <ul>
                                                                    <?php foreach ($cat['children'] as $children) { ?>
                                                                        <li class="">
                                                                            <a href="<?php echo CommonHelper::generateUrl('Blog', 'category', array($children['bpcategory_id'])); ?>"><?php
