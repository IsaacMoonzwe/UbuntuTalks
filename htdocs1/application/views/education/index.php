...
$contactFrm->setFormTagAttribute('action', CommonHelper::generateUrl('Education', 'contactSubmit'));
        ...
        <div class="section contact-form">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 banner-images">
                        <div class="banner__media ">
                            <img src="<?php echo CommonHelper::generateUrl('Image', 'EducationCampaign', [$siteLangId]); ?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="row align-items-center referral-campaign-form">
                    <div class="col-lg-6">
                        <div class="banner__media_content">
                            <?php echo FatUtility::decodeHtmlEntities($EducationCampaignLeftSectionBanner); ?>
                        </div>
                    </div>
                    <div class="col-lg-1">
                    </div>
                ...
                <?php echo FatUtility::decodeHtmlEntities($EducationCampaignBenifitsBanner); ?>
            </div>
        </div>
    </div>
</section>
