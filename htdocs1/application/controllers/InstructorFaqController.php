...
class InstructorFaqController extends MyAppController
{

    public function index()
    {
        $srch = InstructorFaq::getSearchObject($this->siteLangId);
        ...
        $this->set('typeArr', InstructorFaq::getFaqCategoryArr($this->siteLangId));
