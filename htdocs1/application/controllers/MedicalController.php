...
class MedicalController extends MyAppController
{
    ...
    public function index()
    {
        ...
        $MedicalCampaignLeftSectionBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_MEDICAL_CAMPAIGN_LEFT_SECTION_BANNER, $this->siteLangId);
        $MedicalCampaignBenifitsBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_MEDICAL_CAMPAIGN_BENEFITS_SECTION_BANNER, 
        $this->siteLangId);
        $this->set('MedicalCampaignBenifitsBanner', $MedicalCampaignBenifitsBanner);
        $this->set('ReferralCampaignBanner', $ReferralCampaignBanner);
        $this->set('MedicalCampaignLeftSectionBanner', $MedicalCampaignLeftSectionBanner);
    ...
    public function contactSubmit()
    {
        ...
        if (false === $post) {
            ...
            FatApp::redirectUser(CommonHelper::generateUrl('medical'));
        }
        ...
        foreach ($email as $emailId) {
            ...
            if (!$email->sendMedicalFormEmail($emailId, $this->siteLangId, $post)) {
