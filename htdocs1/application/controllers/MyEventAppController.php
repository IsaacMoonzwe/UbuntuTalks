...
class MyEventAppController extends FatController
{
    ...
    public function __construct($action)
    {
        ...
        // if (
        //         FatApp::getConfig("CONF_MAINTENANCE", FatUtility::VAR_INT, 0) &&
        //         ($this->_controllerName != "MaintenanceController") &&
        //         ($this->_controllerName != 'Home' && $action != 'setSiteDefaultLang' &&
        //         $this->_controllerName != 'Custom' && $action != 'updateUserCookies' &&
        //         $action != 'cookieForm' && $action != 'saveCookieSetting')
        // ) {
        //     EventUserAuthentication::logout();
    ...
    public function setUpNewsLetter()
    {
        ...
        if ($api_key == '' || $list_id == '') {
            FatUtility::dieJsonError(Label::getLabel("LBL_Newsletter_is_not_configured_yet,_Please_contact_admin"));
        }
        ...
        try {
            ...
            FatUtility::dieJsonError(Label::getLabel('MSG_ERROR_WHILE_SUBSCRIBING_TO_NEWSLETTER'));
        }
