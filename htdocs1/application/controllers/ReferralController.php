...
class ReferralController extends MyAppController
{
    ...
    public function index()
    {
        ...
        $ReferralCampaignLeftSectionBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_REFERRAL_CAMPAIGN_LEFT_SECTION_BANNER, $this->siteLangId);
        $ReferralCampaignBenifitsBanner = ExtraPage::getBlockContent(ExtraPage::BLOCK_REFERRAL_CAMPAIGN_BENEFITS_SECTION_BANNER, 
        $this->siteLangId);
