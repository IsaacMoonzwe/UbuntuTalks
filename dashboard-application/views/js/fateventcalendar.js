...
var FatEventCalendar = function (teacherId) {
    ...
    this.calDefaultConf = {
        ...
        // googleCalendarApiKey: 'AIzaSyBt-pJuGGPLXrYjqfrKPO-wSPdwZGTXf-E',
        // eventSources: 
        // {
        //     googleCalendarId: 'demo.logixbuiltinfo@gmail.com'
        // },
        slotDuration: '00:15',
        slotLabelFormat: {
            hour12: true,
...
FatEventCalendar.prototype.validateSelectedSlot = function (arg, current_time, duration, bookingBefore=24) {
    var start = arg.startStr;
    var end = arg.endStr;
    var getNexthours=moment(current_time).add(24,'hours').format('YYYY-MM-DD HH:mm:ss');
    ...
    if (selectedDateTime < validSelectDateTime || selectedDateTime < getNexthours) {
        return false;
    }
...
FatEventCalendar.prototype.WeeklyBookingCalendar = function (current_time, duration, bookingBefore=24) {
    var fecal = this;
    ...
    var calConf = {
        ...
        select: function (arg) {
            ...
            if (!fecal.validateSelectedSlot(arg, current_time, duration, bookingBefore)) {
                jQuery.mbsmessage("Book the class after 24 Hours",true, 'alert alert--danger');
                jQuery("#loaderCalendar").hide();
                jQuery("body").css({ "cursor": "default" });
                jQuery("body").css({ "pointer-events": "initial" });
                calendar.unselect();
...
FatEventCalendar.prototype.TeacherWeeklyAvailaibility = function (current_time) {
    var calConf = {
        ...
        events: function (fetchInfo, successCallback, failureCallback) {
            postData = "start=" + moment(fetchInfo.start).format('YYYY-MM-DD HH:mm:ss') + "&end=" + moment(fetchInfo.end).format('YYYY-MM-DD HH:mm:ss') + "&bookingBefore=24";
