...
$imgFld = $frm->getField('tlpn_image');
...
$fld = $frm->getField('grpcls_total_lesson');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_max_learner');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_max_one_on_one_learner');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_ages');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('tlpn_image');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_tlanguage_id');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_entry_fee');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_one_on_one_entry_fee');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_start_datetime');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_duration');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_kids_title');
$fld->developerTags['col'] = 6;
$fld = $frm->getField('grpcls_kids_youtube_link');
$fld->developerTags['col'] = 6;
...
$fld = $frm->getField('grpcls_schedule');
if (!is_null($fld)) {
    $fld->developerTags['col'] = 6;
}
$fld = $frm->getField('grpcls_learning_goals');
if (!is_null($fld)) {
    $fld->developerTags['col'] = 6;
}
$fld = $frm->getField('grpcls_supply_list');
if (!is_null($fld)) {
    $fld->developerTags['col'] = 6;
}
$fld = $frm->getField('grpcls_parental_guidance');

if (!is_null($fld)) {
    $fld->developerTags['col'] = 12;
}
$fld = $frm->getField('grpcls_class_experience');
if (!is_null($fld)) {
    $fld->developerTags['col'] = 6;
}
...
<div class="popup">
    <div class="popup__head">
        <h4><?php echo Label::getLabel("LBL_Add_Kids_Class") ?></h4>
