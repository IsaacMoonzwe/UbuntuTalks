...
$passedLabel = Label::getLabel('LBL_PASSED');
?>
<div class="table-scroll">
    <table class="table table--styled table--responsive">
        ...
        <?php foreach ($classes as $i => $class) {
            $statusLabel = $classStatusArr[$class['grpcls_status']];
            if ($class['grpcls_status'] == TeacherGroupClasses::STATUS_ACTIVE && strtotime($class['grpcls_end_datetime']) < time()) {
                $statusLabel = $passedLabel;
            }
        ?>
            <tr>
                <td>
                ...
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content"><span class="badge color-secondary badge--curve"><?php echo $statusLabel; ?></span></div>
                    </div>
                </td>
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <div class="actions-group">
                                ...
                                <?php if ($class['grpcls_status'] == TeacherGroupClasses::STATUS_ACTIVE) { ?>
                                    <a ref="javascript:void(0);" onclick="duplicateClass('<?php echo $class['grpcls_id']; ?>');" class="btn btn--bordered btn--shadow btn--equal margin-1 is-hover">
                                            <svg class="icon icon--issue icon--small duplicate-icons">
                                                <use xlink:href="<?php echo CONF_WEBROOT_URL . 'images/sprite.yo-coach.svg#message'; ?>"></use>
                                            </svg>
                                            <div class="tooltip tooltip--top bg-black"><?php echo Label::getLabel("LBL_Add_Duplicate_Entry"); ?></div>
                                        </a>
