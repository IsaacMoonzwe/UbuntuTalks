<div class="box -padding-20">
    <h4><?php echo Label::getLabel('LBL_Change_Plan'); ?></h4>
    <?php if ($countData == 0) { ?>
        <div class="box -padding-30" style="margin-bottom: 30px;">
            <div class="message-display">
                ...
                <h5><?php echo Label::getLabel('LBL_No_Other_Plan_Avaiable!!'); ?></h5>
        ...
        <div class="table-scroll">
            <table class="table">
                <tbody><tr class="-hide-mobile">
                    ...
                    <?php
                    $i = 1;
                    foreach ($lessonsPlanData as $lessonPlanData) {
                        ?>
                        <tr>
                            <td>
                            ...
                            <td>
                                <span class="td__data"><?php echo $lessonPlanData['tlpn_title']; ?></span>
                            </td>
                            <td><?php
                                ...
                                if (empty($file_row)) {
                                    ...
                                    ?>
                                    <span class="td__data"><img src="<?php echo CommonHelper::generateFullUrl('TeacherLessonsPlan', 'lessonPlanImage', array($lessonPlanData['tlpn_id'], 'THUMB')) . '?' . time(); ?>" /></span>
                                <?php } ?>
                            </td>
                            <td>
                                <span class="td__data"><?php echo $statusArr[$lessonPlanData['tlpn_level']]; ?></span>
                            </td>
                            <td>
                                <a href="javascript:void(0);" class="btn btn--secondary" onclick="assignLessonPlanToLessons('<?php echo $lessonId; ?>', '<?php echo $lessonPlanData['tlpn_id']; ?>')"><?php echo Label::getLabel('LBL_Assign'); ?></a>
                            </td>
                        </tr>
                        <?php
                        $i++;
