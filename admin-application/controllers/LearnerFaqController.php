...
class LearnerFaqController extends AdminBaseController
{
    ...
    {   
        ...
        $this->_template->render(true, true, 'learner-faq/index.php');
    }

    public function search()
    {
       
        $srch = LearnerFaq::getSearchObject($this->adminLangId, false);
        ...
        $this->_template->render(false, false, 'learner-faq/search.php');
    }
    ...
    public function form($faqId)
    {
        ...
        if (0 < $faqId) {
            $data = LearnerFaq::getAttributesById($faqId, ['faq_id', 'faq_identifier', 'faq_category', 'faq_active']);
            if ($data === false) {
        ...
        $this->set('frm', $frm);
        //$this->_template->render(false, false);
        $this->_template->render(false, false, 'learner-faq/form.php');
    }
    ...
    public function setup()
    {
        ...
        if ($faqId > 0) {
            ...
            foreach ($languages as $langId => $langName) {
                if (!$row = LearnerFaq::getAttributesByLangId($langId, $faqId)) {
                    $newTabLangId = $langId;
                    break;
                }
            }
    ...
    public function langForm($faqId = 0, $lang_id = 0)
    {
        ...
        $langData = LearnerFaq::getAttributesByLangId($lang_id, $faqId);
        ...
        $this->_template->render(false, false, 'learner-faq/lang-form.php');
    }
    ...
    public function changeStatus()
    {
        ...
        $data = LearnerFaq::getAttributesById($faqId, ['faq_id', 'faq_active']);
        if ($data == false) {
    ...
    public function deleteRecord()
    {
        ...
        $LessonPackageObj = new LearnerFaq($faq_id);
