...
class CorporatesInformationController extends AdminBaseController
{
    ...
    {
        $CorporateSection = new SearchBase('tbl_event_user_corporate_sponser');
        $CorporateSection->addOrder('event_user_corporate_id', 'DESC');
        $CorporateSection->addCondition('event_user_payment_status', '=', '1');
        $Corporate_categories = $CorporateSection->getResultSet();
        $CorporateCategoriesList = FatApp::getDb()->fetchAll($Corporate_categories);
        foreach ($CorporateCategoriesList as $key => $value) {
            $eventsDetails = new SearchBase('tbl_corporate_ticket_sponsorship');
            $eventsDetails->addCondition('corporate_ticket_id', ' = ', $value['event_corporate_sponsership_id']);
            ...
            $value['corporate_ticket_title'] = $eventsDeatailsCategoriesListing['corporate_ticket_category_type'];
            $value['corporate_discount'] = $eventsDeatailsCategoriesListing['corporate_ticket_discount'];
            ...
            $CorporateCategoriesList[$key] = $value;
        }
        $this->set("CorporateCategoriesList", $CorporateCategoriesList);
