...
// $frm->getField('benefit_concert_artists_starting_date')->setFieldTagAttribute('data-fatdatetimeformat', $dateformat . ' ' . $timeformat);
// $frm->getField('benefit_concert_artists_ending_date')->setFieldTagAttribute('data-fatdatetimeformat', $dateformat . ' ' . $timeformat);
?>
