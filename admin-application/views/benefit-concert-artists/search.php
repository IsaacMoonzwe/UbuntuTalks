...
$arr_flds = array(
    ...
    'benefit_concert_artists_plan_title' => Label::getLabel('LBL_Benefit_Concert_Artists_Title', $adminLangId) ,
    'benefit_concert_artists_video_link' => Label::getLabel('LBL_Video_Link', $adminLangId) ,
    // 'benefit_concert_artists_starting_days' => Label::getLabel('LBL_benefit_concert_artists_Starting_Days', $adminLangId) ,
    'benefit_concert_artists_plan_description' => Label::getLabel('LBL_Description', $adminLangId) ,
    //'event_agenda_schedule' => Label::getLabel('LBL_View_Agenda_Schedule', $adminLangId) ,
    'benefit_concert_artists_active' => Label::getLabel('LBL_Status', $adminLangId) ,
...
foreach ($arr_listing as $sn => $row)
{
    ...
    $tr->setAttribute("id", $row['benefit_concert_artists_id']);
    ...
    foreach ($arr_flds as $key => $val)
    {
        ...
        {
            case 'dragdrop':
                if ($row['benefit_concert_artists_active'] == applicationConstants::ACTIVE) {
            ...
            case 'event_agenda_schedule':
                ...
                if ($canEdit)
                {
                    ...
                    $li->appendElement('a', array(
                        ...
                        "onclick" => "editTestimonialAgendaFormNew(" . $row['benefit_concert_artists_id'] . ")",
            ...
            break;
            case 'benefit_concert_artists_active':
                $active = "";
                $statusAct = '';
                if ($row['benefit_concert_artists_active'] == applicationConstants::YES && $canEdit === true)
                {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['benefit_concert_artists_active'] == applicationConstants::NO && $canEdit === true)
                {
                    $active = '';
                ...
                $str = '<label class="statustab -txt-uppercase">                 
                     <input ' . $active . ' type="checkbox" id="switch' . $row['benefit_concert_artists_id'] . '" value="' . $row['benefit_concert_artists_id'] . '" onclick="' . $statusAct . '" class="switch-labels status_' . $row['benefit_concert_artists_id'] . '"/>
            ...
            case 'action':
                ...
                if ($canEdit)
                {
                    ...
                    $innerLiEdit->appendElement('a', array(
                        ...
                        'class' => 'button small green',
                        'title' => Label::getLabel('LBL_Edit', $adminLangId) ,
                        "onclick" => "editTestimonialFormNew(" . $row['benefit_concert_artists_id'] . ")"
                    ...
                    $innerLiDelete->appendElement('a', array(
                        ...
                        "onclick" => "deleteRecord(" . $row['benefit_concert_artists_id'] . ")"
    ...
    $(document).ready(function () {
        $('#paymentMethod').tableDnD({
            onDrop: function (table, row) {
                ...
                fcom.ajax(fcom.makeUrl('BenefitConcertArtists', 'updateOrder'), order, function (res) {
