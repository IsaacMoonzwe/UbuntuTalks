                ...
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Label::getLabel('LBL_Manage_Commission_Settings', $adminLangId); ?> </h5>
                ...
                <section class="section">
                    <div class="sectionhead">
                        <h4><?php
                            ...
                            echo Label::getLabel('LBL_Commission_Settings_List', $adminLangId);
                            ?></h4>
                        <?php
                        if ($canEdit) {
                            ...
                            $innerLiAddCat->appendElement('a', array('href' => 'javascript:void(0)', 'class' => 'button small green', 'title' => Label::getLabel('LBL_Add_New', $adminLangId), "onclick" => "editCommissionForm(0)"), Label::getLabel('LBL_Add_New', $adminLangId), true);
                            echo $ul->getHtml();
                        }
                        ?>
                    </div>
