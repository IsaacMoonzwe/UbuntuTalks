...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Job_Function_Dropdown_List_Setup', $adminLangId); ?></h4>
    </div>
            ...
            <div class="col-sm-12">
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        ...
                        ?>
                        <!-- <li><a href="javascript:void(0);" <?php if ($testimonialId > 0) { ?> onclick="testimonialMediaForm(<?php echo $testimonialId ?>);" <?php } ?>><?php echo Label::getLabel('LBL_Media', $adminLangId); ?></a></li> -->
                    </ul>
