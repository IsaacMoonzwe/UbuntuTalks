...
$arr_flds = array(
    ...
    'accommodations_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'accommodations_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'accommodations_identifier':
                if ($row['accommodations_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['accommodations_label'], true);
                ...
                break;
            case 'accommodations_active':
                $active = "";
                $statusAct = '';
                if ($row['accommodations_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['accommodations_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
