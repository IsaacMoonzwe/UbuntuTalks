...
$arr_flds = array(
    ...
    'event_press_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'event_press_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'event_press_identifier':
                if ($row['event_press_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['event_press_label'], true);
                ...
                break;
            case 'event_press_active':
                $active = "";
                $statusAct = '';
                if ($row['event_press_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['event_press_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
