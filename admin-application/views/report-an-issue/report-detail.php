...
<div>
    ...
    ?>
        ...
        <hr>
        <?php if ($value['report_comments_admin_information'] != '') {
        ?>
            <div class="row">
                <div class="col-md-1">
                </div>
                <div class="col-md-9">
                    ...
                    <?php echo $value['report_comments_admin_information']; ?>
                </div>
                <div class="col-md-1">
                </div>
            </div>
                            ...
                            <div class="col-md-12">
                                <div class="field-wraper">
                                    <div class="field_cover">
                                        <?php echo $agendafrm->getFieldHTML('report_comments_admin_information'); ?>
                                    </div>
                                </div>
                            </div>
