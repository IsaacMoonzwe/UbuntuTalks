                ...
                <div class="row">
                    <section class="section">
                        <div class="sectionbody">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="shop-template">
                                    <a rel="facebox" onClick="displayImageInFacebox('<?php echo CommonHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/banner_layouts/layout-2.jpg');" href="javascript:void(0)">
                                        ...
                                        <p><?php echo Label::getLabel('LBL_Layout_2', $adminLangId); ?></p>
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="shop-template">
                                    <a rel="facebox" onClick="displayImageInFacebox('<?php echo CommonHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/banner_layouts/layout-3.jpg');" href="javascript:void(0)">
                                        ...
                                        <p><?php echo Label::getLabel('LBL_Layout_3', $adminLangId); ?></p>
                                    </a>
                                </div>
                            </div>
                        </div>
