            ...
            <div class="space">
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Label::getLabel('LBL_Manage_Timezones', $adminLangId); ?> </h5>
                ...
                <section class="section searchform_filter">
                    ...
                    <div class="sectionbody space togglewrap" style="display:none;">
                        <?php
                        $search->setFormTagAttribute('onsubmit', 'searchTimezone(this); return(false);');
                ...
                <section class="section">
                    <div class="sectionhead">
                        <h4><?php echo Label::getLabel('LBL_Timezone_Listing', $adminLangId); ?></h4>
                    </div>
