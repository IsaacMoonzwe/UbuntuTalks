            ...
            <div class="col-sm-12">
                <div class="col-sm-12">
                    <div class="tabs_nav_container responsive flat">
                        <ul class="tabs_nav">
                            <li><a href="javascript:void(0);" onclick="addForm(<?php echo $nav_id ?>);"><?php echo Label::getLabel('LBL_General', $adminLangId); ?></a></li>
                            <?php
                            if ($nav_id > 0) {
                                foreach ($languages as $langId => $langName) {
                                    ?>
                                    <li><a class="<?php echo ($nav_lang_id == $langId) ? 'active' : '' ?>" href="javascript:void(0);" 
                                           onclick="addLangForm(<?php echo $nav_id ?>, <?php echo $langId; ?>);"><?php echo $langName; ?></a></li>
                                        <?php
                                    }
                                }
                                ?>
