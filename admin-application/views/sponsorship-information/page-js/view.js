...
(function() {
	...
	updatePayment = function (frm){
		...
		fcom.updateWithAjax(fcom.makeUrl('SponsorshipInformation', 'updatePayment'), data, function(t) {
	...
	updateAssignClassStatus = function(obj, id, value, oldValue){
		...
		fcom.ajax(fcom.makeUrl('SponsorshipInformation','updateAssignClass'),{"sldetail_id":id, "slesson_status" : value},function(json){
			res = $.parseJSON(json);
			if(res.status == "1"){
