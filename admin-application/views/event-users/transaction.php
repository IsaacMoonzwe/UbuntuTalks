...
<section class="section">
    ...
    <div class="tabs_nav_container responsive flat">
        <ul class="tabs_nav">
            ...
            <li><a href="javascript:void(0)" onclick="addUserTransaction(<?php echo $userId ?>);"><?php echo Label::getLabel('LBL_Add_New', $adminLangId); ?></a></li>				
        </ul>
        <div class="tabs_panel_wrap">			
            <div class="tabs_panel">
                <?php
                $arr_flds = array(
                    'utxn_id' => Label::getLabel('LBL_Transaction_Id', $adminLangId),
                    'utxn_date' => Label::getLabel('LBL_Date', $adminLangId),
                    'utxn_credit' => Label::getLabel('LBL_Credit', $adminLangId),
                    'utxn_debit' => Label::getLabel('LBL_Debit', $adminLangId),
                    'balance' => Label::getLabel('LBL_Balance', $adminLangId),
                    'utxn_comments' => Label::getLabel('LBL_Description', $adminLangId),
                    'utxn_status' => Label::getLabel('LBL_Status', $adminLangId),
                );
                ...
                foreach ($arr_listing as $sn => $row) {
                    ...
                    foreach ($arr_flds as $key => $val) {
                        ...
                        switch ($key) {
                            case 'utxn_id':
                                $td->appendElement('plaintext', array(), Transaction::formatTransactionNumber($row[$key]));
                                break;
                            case 'utxn_date':
                            ...
                            case 'balance':
                                ...
                                break;
                            case 'utxn_comments':
                                $td->appendElement('plaintext', array(), Transaction::formatTransactionComments($row[$key]), true);
                                break;
                            case 'utxn_status':
