...
foreach ($classes as $sn => $row) {
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                $td->appendElement('span', ['class'=>'sr-no'], $sr_no);
                break;
            case 'teacher_name':
            ...
            case 'action':
                ...
                if ($row['grpcls_status'] != TeacherGroupClasses::STATUS_COMPLETED && $row['grpcls_status'] != TeacherGroupClasses::STATUS_CANCELLED) {
