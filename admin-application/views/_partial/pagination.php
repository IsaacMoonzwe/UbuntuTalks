...
$ul = new HtmlElement('ul', array('class' => 'pagination',), $pagination, true);
?>
<div class="section footinfo">
    <aside class="grid_1"><?php echo $ul->getHtml(); ?></aside>
    <aside class="grid_2"><?php echo Label::getLabel('LBL_Showing', $adminLangId); ?> <?php echo $startIdx = ($pageNumber - 1) * $pageSize + 1; ?> <?php echo Label::getLabel('LBL_to', $adminLangId); ?> <?php echo ($recordCount < $startIdx + $pageSize - 1 ) ? $recordCount : $startIdx + $pageSize - 1; ?> <?php echo Label::getLabel('LBL_of', $adminLangId); ?> <?php echo $recordCount; ?> <?php echo Label::getLabel('LBL_Entries', $adminLangId); ?></aside>
</div>