...
$arr_flds = array(
    ...
    'program_speakers_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'program_speakers_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'program_speakers_identifier':
                if ($row['program_speakers_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['program_speakers_label'], true);
                ...
                break;
            case 'program_speakers_active':
                $active = "";
                $statusAct = '';
                if ($row['program_speakers_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['program_speakers_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
