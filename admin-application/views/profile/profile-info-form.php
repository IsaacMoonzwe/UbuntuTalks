...
<div class="col-lg-4 col-md-4 col-sm-4">
    <div class="section section--profile-box -align-center">
        <div class="sectionbody space">
            ...
            <div class="avtar avtar--large"><img src="<?php echo CommonHelper::generateUrl('profile', 'profileImage', array(AdminAuthentication::getLoggedAdminId(), 'croped', true)) . '?' . time(); ?>" alt=""></div>
            <span class="-gap"></span><span class="-gap"></span>
            <div class="btngroup--fix">
                ...
                <p><br>
                    <a class="themebtn btn-default btn-sm" href="javascript:void(0)" onClick="removeProfileImage()"><?php echo Label::getLabel('LBL_Remove', $adminLangId); ?></a></p>
