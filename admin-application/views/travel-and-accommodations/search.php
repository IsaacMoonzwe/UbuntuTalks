...
$arr_flds = array(
    ...
    'travel_and_accommodations_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'travel_and_accommodations_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'travel_and_accommodations_identifier':
                if ($row['travel_and_accommodations_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['travel_and_accommodations_label'], true);
                ...
                break;
            case 'travel_and_accommodations_active':
                $active = "";
                $statusAct = '';
                if ($row['travel_and_accommodations_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['travel_and_accommodations_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
