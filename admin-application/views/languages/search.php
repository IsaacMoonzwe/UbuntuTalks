...
$arr_flds = array(
    ...
    'language_name' => Label::getLabel('LBL_Language_Name', $adminLangId),
    'language_active' => Label::getLabel('LBL_Status', $adminLangId),
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array('href' => 'javascript:void(0)', 'class' => 'button small green',
                        'title' => Label::getLabel('LBL_Edit', $adminLangId), "onclick" => "editLanguageForm(" . $row['language_id'] . ")"), '<i class="ion-edit icon"></i>',
                            true);
                }
                break;
