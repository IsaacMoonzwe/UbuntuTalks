                ...
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        ...
                        foreach ($languages as $langId => $langName) {
                            ?>
                            <li class="<?php echo $inactive; ?>"><a href="javascript:void(0);" <?php if ($slide_id > 0) { ?> onclick="slideLangForm(<?php echo $slide_id ?>, <?php echo $langId; ?>);" <?php } ?>> <?php echo $langName; ?></a></li>
                        <?php } ?>
