...
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Coupon_History', $adminLangId); ?> (<?php echo $couponData['coupon_code']; ?>)</h4>
    </div>
            ...
            <div class="col-sm-12">
                <div class=" sectionbody space">			
                    <div class="border-box border-box--space">
                        <?php
                        $arr_flds = array(
                            'couponhistory_order_id' => Label::getLabel('LBL_Order_Id', $adminLangId),
                            'credential_username' => Label::getLabel('LBL_Customer', $adminLangId),
                            'couponhistory_amount' => Label::getLabel('LBL_Amount', $adminLangId),
                            'couponhistory_added_on' => Label::getLabel('LBL_Date', $adminLangId),
                        );
