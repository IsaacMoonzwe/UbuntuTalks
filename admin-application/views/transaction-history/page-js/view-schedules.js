(function () {
    ...
    viewDetail = function (opayment_order_id) {
        $.facebox(function () {
            fcom.ajax(fcom.makeUrl('TransactionHistory', 'viewDetail', [opayment_order_id]), '', function (t) {
                console.log(opayment_order_id);
    ...
    updateAssignClassStatus = function(obj, id, value, oldValue){
		...
		fcom.ajax(fcom.makeUrl('TransactionHistory','updateAssignClass'),{"sldetail_id":id, "teachers_id" : value},function(json){
			res = $.parseJSON(json);
