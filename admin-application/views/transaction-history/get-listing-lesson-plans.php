<div class="box -padding-20">
    <a href="<?php echo CommonHelper::generateUrl('TeacherLessonsPlan'); ?>" class="left" ><?php echo Label::getLabel('LBL_Add_New_Lesson_Plan'); ?></a>
            ...
            <tbody><tr class="-hide-mobile">
                ...
                foreach ($lessonsPlanData as $lessonPlanData) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" onclick="assignLessonPlanToLessons('<?php echo $lessonId; ?>', '<?php echo $lessonPlanData['tlpn_id']; ?>')"><?php echo Label::getLabel('LBL_Assign'); ?></a>
                        </td>
                    </tr>
                    <?php
                    $i++;
