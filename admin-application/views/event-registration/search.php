...
$arr_flds = array(
    ...
    'event_registration_identifier' => Label::getLabel('LBL_Title', $adminLangId),
    'event_registration_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'listserial':
                ...
                break;
            case 'event_registration_identifier':
                if ($row['event_registration_label'] != '') {
                    $td->appendElement('plaintext', array(), $row['event_registration_label'], true);
                ...
                break;
            case 'event_registration_active':
                $active = "";
                $statusAct = '';
                if ($row['event_registration_active'] == applicationConstants::YES) {
                    $active = 'checked';
                    $statusAct = 'inactiveStatus(this)';
                }
                if ($row['event_registration_active'] == applicationConstants::NO) {
                    $active = 'unchecked';
