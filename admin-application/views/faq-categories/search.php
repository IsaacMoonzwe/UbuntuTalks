...
$arr_flds = array(
    'dragdrop' => '',
    'select_all' => Label::getLabel('LBL_Select_all', $adminLangId),
    'listserial' => Label::getLabel('LBL_Sr._No', $adminLangId),
    'faqcat_identifier' => Label::getLabel('LBL_category_Name', $adminLangId),
    'faqcat_active' => Label::getLabel('LBL_Status', $adminLangId),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    $innerLiEdit = $innerUl->appendElement('li');
                    $innerLiEdit->appendElement('a', array('href' => 'javascript:void(0)', 'class' => 'button small green', 'title' => Label::getLabel('LBL_Edit', $adminLangId), "onclick" => "addFaqCatForm(" . $row['faqcat_id'] . ")"), Label::getLabel('LBL_Edit', $adminLangId), true);
                }
                if ($canEdit) {
                    $innerLiDelete = $innerUl->appendElement('li');
                    $innerLiDelete->appendElement('a', array('href' => "javascript:void(0)", 'class' => 'button small green', 'title' => Label::getLabel('LBL_Delete', $adminLangId), "onclick" => "deleteRecord(" . $row['faqcat_id'] . ")"), Label::getLabel('LBL_Delete', $adminLangId), true);
                }
                break;
            default:
                $td->appendElement('plaintext', array(), $row[$key], true);
...
<?php echo FatUtility::createHiddenFormFromData($postedData, array('name' => 'frmFaqCatSearchPaging')); ?>
<script>
